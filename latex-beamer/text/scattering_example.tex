...
\begin{frame}[fragile]{Trying out different hole-ice scattering lengths}
  ...
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      ...
      \vspace{1cm}
      \tiny{Colors indicate simulation steps, i.e. number of scatterings relative to the total number until absorption. \color{red}{Red}: Photon just created, \color{blue}{blue}: Photon about to be absorbed.}
